...
function fillMenus($root) {
  ...
  const quotes = [
    '稻盛商学院以“敬天爱人”为核心，<br />培育德才兼备的商道人才，<br />引领企业可持续发展。',
    '立足浙江工商大学，<br />推进管理教育与社会服务协同发展，<br />欢迎加入稻盛商学院！',
    '勤奋、严谨、<br />求实、创新。',
    '思想自由、兼容并包。<br /><br />以实践检验真知，<br />以商道成就事业。',
    '博学之，审问之，<br />慎思之，明辨之，<br />笃行之。',
    '志于道，据于德，<br />依于仁，游于艺。',
    '春秋冬夏，<br />与工商校园同频成长，<br />在稻盛商学院，<br />见证更好的自己。'
  ]
